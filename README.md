...
The Smart Intermediate Representation(short for IR) project is a new cmlompiler framework intended for smart contract development, which is mainly inspired by LLVM, MLIR and Solidity/Yul. The compiler's goals are:
